        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                <div class="hero-image text-center">
                    <img src="<?php echo e(asset('images/van-hero.png')); ?>" alt="Travel Van" class="img-fluid floating-animation"
...
<div class="container mx-auto px-2">
    ...
    <section class="filter-section mb-5" data-aos="fade-up">
        <div class="card border-0 shadow-lg rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4">
                <form method="GET" action="<?php echo e(route('home')); ?>" class="row g-4 align-items-end">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="seats" value="<?php echo e(request('seats')); ?>"
                    ...
                    <div class="col-12 col-md-2 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-secondary w-100 fw-semibold py-2">
    ...
    <section id="vans" class="vans-section mb-5">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $vans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $van): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-12 col-sm-6 col-lg-4" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="card van-card h-100 shadow-sm border-0 rounded-4 overflow-hidden position-relative
                    <?php if(isset($latestBookingId) && $van->id == $latestBookingId): ?> new-booking-highlight <?php endif; ?>">

                    <!-- New Booking Badge -->
                    <?php if(isset($latestBookingId) && $van->id == $latestBookingId): ?>
                    ...
                    <div class="van-image-container position-relative overflow-hidden">
                        <?php if($van->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($van->image)): ?>
                            <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($van->image)); ?>"
                                 class="card-img-top van-image" alt="<?php echo e($van->name); ?>">
                        <?php else: ?>
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        <div class="van-header mb-3">
                            <h5 class="card-title fw-bold text-dark mb-2"><?php echo e($van->name); ?></h5>
                            <div class="van-features d-flex flex-wrap gap-2 mb-3">
                                <span class="badge bg-light text-dark">
                                    <i class="fas fa-users me-1 text-primary"></i><?php echo e($van->seats); ?> Seats
                                </span>
                                <span class="badge bg-light text-dark">
                                    <i class="fas fa-cog me-1 text-primary"></i><?php echo e($van->model ?? 'Standard'); ?>
                        ...
                        <div class="van-price mb-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <span class="h5 fw-bold text-primary mb-0">LKR <?php echo e(number_format($van->price_per_day)); ?></span>
                            </div>
                        </div>

                        <!-- Book Now Button -->
                        <a href="<?php echo e(route('bookings.create', $van->id)); ?>"
        ...
        <div class="card border-0 shadow-lg rounded-3 overflow-hidden" data-aos="fade-up">
            <div class="card-header bg-gradient-primary text-white py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <span class="badge bg-light text-primary fs-6"><?php echo e($bookings->count()); ?> Bookings</span>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="booking-row">
                                <td class="px-4">
                                    <span class="fw-semibold text-primary">#<?php echo e($booking->id); ?></span>
                                </td>
                                <td class="px-4">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-van-shuttle text-primary me-2"></i>
                                        <span class="fw-semibold"><?php echo e($booking->van->name ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-4">
                                ...
                                <td class="px-4 text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="<?php echo e(route('bookings.cancel', $booking->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trainee\Desktop\New folder\van hire last update\resources\views/home.blade.php ENDPATH**/ ?>