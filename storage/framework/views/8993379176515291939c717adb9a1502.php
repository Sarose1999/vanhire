...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto max-w-4xl bg-white print-shadow rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-8 text-center">
            ...
            <p class="text-blue-100 text-lg">Booking Reference: #<?php echo e($booking->id); ?></p>
            <p class="text-blue-100">Issued: <?php echo e(now()->format('F d, Y')); ?></p>
        </div>
...
<?php /**PATH C:\Users\trainee\Desktop\New folder\van hire last update\resources\views/admin/bookings/invoice.blade.php ENDPATH**/ ?>