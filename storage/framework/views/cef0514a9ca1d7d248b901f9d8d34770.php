                ...
                <div id="notification-dropdown" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 hidden transform origin-top-right transition-all duration-300 scale-95 opacity-0">
                    ...
                    <div id="notification-list" class="max-h-96 overflow-y-auto">
                        <?php if($notificationCount > 0): ?>
                            ...
                            <div class="notification-item border-b border-gray-100 last:border-b-0" data-notification-id="<?php echo e($note->id); ?>">
                                <div class="p-3 hover:bg-gray-50 transition-colors">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-800"><?php echo e($note->data['message']); ?></p>
                                            <div class="mt-2 flex justify-between items-center">
                                                <span class="text-xs font-medium text-blue-600">Booking #<?php echo e($note->data['booking_id']); ?></span>
                                                <form method="POST" action="<?php echo e(route('admin.notifications.read', $note->id)); ?>" class="mark-read-form">
                                                    <?php echo csrf_field(); ?>
