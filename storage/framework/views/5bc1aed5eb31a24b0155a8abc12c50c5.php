...
<div class="container mt-5">
    <div class="card shadow-lg border-0 rounded-4 animate-fade-in">
        <div class="card-header bg-gradient-primary text-white text-center py-4 rounded-top-4">
            ...
            <p class="mb-0 opacity-75">Booking #<?php echo e($booking->id); ?></p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 text-center mb-4 animate-slide-left">
                    <div class="position-relative">
                        <?php if($booking->van->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($booking->van->image)): ?>
                            <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($booking->van->image)); ?>"
                                 alt="<?php echo e($booking->van->name); ?>"
                                 class="img-fluid rounded-3 shadow-lg van-image">
                        <?php else: ?>
                            <img src="<?php echo e(asset('images/default-van.png')); ?>"
                                 alt="Default Image"
                                 class="img-fluid rounded-3 shadow-lg van-image">
                        <?php endif; ?>
                    ...
                    <div class="mt-4 p-3 bg-light rounded-3">
                        <h5 class="fw-bold text-primary mb-2"><?php echo e($booking->van->name); ?></h5>
                        <div class="d-flex justify-content-between text-sm">
                            <span class="text-muted">
                                <i class="bi bi-people me-1"></i>
                                <?php echo e($booking->van->seats); ?> Seats
                            </span>
                            <span class="text-muted">
                                <i class="bi bi-speedometer2 me-1"></i>
                                <?php echo e($booking->van->model ?? 'Standard'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($booking->pickup_location ?? 'Not specified'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($booking->dropoff_location ?? 'Not specified'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e(\Carbon\Carbon::parse($booking->start_date)->format('d M Y')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e(\Carbon\Carbon::parse($booking->end_date)->format('d M Y')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e(\Carbon\Carbon::parse($booking->time)->format('h:i A')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e(\Carbon\Carbon::parse($booking->created_at)->format('d M Y h:i A')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold"><?php echo e($booking->total_days); ?> days</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold">Rs. <?php echo e(number_format($booking->van->price_per_day, 2)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="total-price-section mt-3 p-3 bg-gradient-success text-white rounded-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold animate-pulse">Rs. <?php echo e(number_format($booking->total_price, 2)); ?></h3>
                                </div>
            ...
            <div class="row mt-5 animate-fade-up">
                <div class="col-12">
                    <div class="d-flex flex-wrap gap-3 justify-content-center">
                        <a href="<?php echo e(route('bookings.index')); ?>" class="btn btn-outline-primary btn-lg action-btn">
                            <i class="bi bi-arrow-left-circle me-2"></i> Back to Bookings
                        </a>

                        <?php if($booking->status == 'pending'): ?>
                        <form action="<?php echo e(route('bookings.cancel', $booking->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to cancel this booking?');">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(route('bookings.invoice', $booking->id)); ?>" class="btn btn-success btn-lg action-btn">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trainee\Desktop\New folder\van hire last update\resources\views/bookings/show.blade.php ENDPATH**/ ?>