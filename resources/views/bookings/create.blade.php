...
<body>
            ...
            <div class="col-lg-10">
                <div class="booking-card">
                    <div class="card-header text-center text-white">
                        <h2 class="mb-0"><i class="fas fa-van-shuttle me-2"></i>Book {{ $van->name }}</h2>
                        <p class="mb-0 mt-2 opacity-75">Complete your booking details below</p>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('bookings.store', $van->id) }}" id="bookingForm">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="fw-bold">${{ $van->price_per_day }}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('home') }}" class="btn btn-outline-secondary flex-fill py-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const vanPrice = {{ $van->price_per_day }};
            ...
            async function checkAvailability() {
                ...
                const url = '{{ route('bookings.checkAvailability', $van->id) }}' +
