    ...
    <div class="admin-container">
        ...
        <div class="page-header" data-aos="fade-down">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.vans.index') }}" class="btn-back">
        ...
        <div class="form-container" data-aos="fade-up" data-aos-delay="200">
            <form action="{{ route('admin.vans.update', $van->id) }}" method="POST" enctype="multipart/form-data" class="edit-form">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" name="name" value="{{ old('name', $van->name) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" name="model" value="{{ old('model', $van->model) }}"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" name="seats" value="{{ old('seats', $van->seats) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="number" name="price_per_day" value="{{ old('price_per_day', $van->price_per_day) }}"
                                           class="form-input" placeholder="Price per day" min="0" step="0.01" required>
                                    <i class="fas fa-money-bill-wave input-icon"></i>
                                </div>
                                <div class="price-preview">
                                    <span class="price-amount">LKR {{ number_format($van->price_per_day, 2) }}</span>
                                ...
                                <div class="image-preview-container">
                                    <div class="image-card">
                                        <img id="image-preview"
                                             src="{{ $van->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($van->image) ? \Illuminate\Support\Facades\Storage::url($van->image) : asset('images/default-van.png') }}"
                                             alt="{{ $van->name }}"
                                             class="preview-image">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.vans.index') }}" class="btn-cancel">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            removeButton.addEventListener('click', function() {
                imagePreview.src = "{{ asset('images/default-van.png') }}";
                imageInput.value = '';
                removeInput.value = 1;
                uploadArea.classList.remove('has-image');
