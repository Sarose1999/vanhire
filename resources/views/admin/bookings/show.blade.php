                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <button type="button"
                                    ...
                                    class="ajax-status-btn group bg-green-500 text-white px-5 py-3 rounded-xl hover:bg-green-600 transition-all duration-300 hover:shadow-md flex items-center gap-2 font-medium transform hover:scale-105">
                            ...
                            <button type="button"
                                    ...
                                    class="ajax-status-btn group bg-blue-500 text-white px-5 py-3 rounded-xl hover:bg-blue-600 transition-all duration-300 hover:shadow-md flex items-center gap-2 font-medium transform hover:scale-105">
                                <i class="fas fa-clipboard-check group-hover:scale-110 transition-transform"></i>
                                Mark Complete
                            </button>
                            @endif
                            ...
                            <button type="button"
                                    data-action-url="{{ route('admin.bookings.updateStatus', $booking->id) }}"
                                    data-status="pending"
                                    class="ajax-status-btn group bg-yellow-500 text-white px-5 py-3 rounded-xl hover:bg-yellow-600 transition-all duration-300 hover:shadow-md flex items-center gap-2 font-medium transform hover:scale-105">
                            ...
                            <button type="button"
                                    ...
                                    class="ajax-status-btn group bg-red-500 text-white px-5 py-3 rounded-xl hover:bg-red-600 transition-all duration-300 hover:shadow-md flex items-center gap-2 font-medium transform hover:scale-105">
                            ...
                            <button type="button"
                                    ...
                                    class="ajax-delete-btn group bg-red-600 text-white px-5 py-3 rounded-xl hover:bg-red-700 transition-all duration-300 hover:shadow-md flex items-center gap-2 font-medium transform hover:scale-105">
